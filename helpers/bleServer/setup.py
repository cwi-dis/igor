...
This server is a helper for the Igor IoT server, <https://github.com/cwi-dis/igor>.
"""
...
setup(
    ...
    description='Scan Bluetooth LE devices',
    ...
    package_data={'bleServer' : ['initscript-bleServer']},
    ...
    entry_points={
        'console_scripts': [
            'bleServer=bleServer.__main__:main',
            'blescan=bleServer.blescan:main',
            ''
        ],
    },
)
